                    ...
                    try:
                        ...
                        if doc['status'] == 'submitted':
                            ...
                            if result.modified_count > 0:
                                ...
                                recorder_process = subprocess.Popen(['python', 'recorder.py', str(doc['_id']), available_cable_name], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
                                
                                # Print output in real-time
                                for line in recorder_process.stdout:
                                    print('recorder.py: ', line.decode().strip())
