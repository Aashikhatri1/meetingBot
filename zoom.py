...
images = ['zoombot_images\\allow_button.png',
          'zoombot_images\\open_zoom_button.png',
          'zoombot_images\\mute_button.png', 'zoombot_images\\browser_button.png',
